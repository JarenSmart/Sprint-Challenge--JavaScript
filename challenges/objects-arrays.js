...
lowCaseAnimalNames = zooAnimals.map(justAnimal => {
  return justAnimal.animal_name.toLowerCase();
});
...
populationTotal = zooAnimals.reduce((totalPop, entireArr) => {
  return totalPop + entireArr.population;
}, 0);
